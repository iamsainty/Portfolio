        ...
        <div className="row">
          <div className="col" style={{ maxWidth: '100%' }}>
            {sociallinks.map((social) => (
              <Link to={`${social.link}`} style={{ textDecoration: 'none', color: 'black' }} key={social.platform}>
                <Card style={{ color: '#191919', background: 'linear-gradient(125deg, #F0F4F8, #FAFAFA)', border: '0.25px solid black' }}>
          ...
          <div className="col-lg-6 d-flex flex-column text-center" style={{ height: 'auto', width: 'auto' }}>
            ...
            >
              ...
              <Link to="/your-portfolio" style={{ fontSize: '2vh', fontWeight: 'bold', textDecoration: 'none', color: 'black' }}>
                <div className='d-flex align-items-center' style={{ border: '1px black solid', width: 'fit-content', paddingLeft: '2vh', paddingRight: '3vh', padding: '1vh', borderRadius: '2.5vh', background: 'linear-gradient(125deg, #F0F4F8, #FAFAFA)' }}>
