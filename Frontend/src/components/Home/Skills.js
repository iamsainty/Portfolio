        ...
        <Row>
          {professions.map((profession, index) => (
            <Col key={index} className={`my-3 mx-3`} >
              <CustomCard ref={(ref) => (cardsRef.current[index] = ref)} style={{background: 'linear-gradient(125deg, #F0F4F8, #FAFAFA)', borderColor: 'black' , border: '0.25px solid',  color: '#191919'}}>
                <BootstrapCard.Body >
