...
import { FiCode, FiCpu, FiDatabase, FiLayout, FiCloud } from "react-icons/fi";

const cards = [
  {
    title: "Full Stack Apps",
    desc: "End-to-end projects with real users",
    icon: FiCode,
  ...
  {
    title: "System Design",
    desc: "Architecture, scalability & decisions",
    icon: FiCpu,
    color: "text-rose-500",
  ...
  },
  {
    ...
    desc: "APIs, databases & optimizations",
    icon: FiDatabase,
  ...
  },
  {
    ...
    desc: "AWS, hosting & production setups",
    icon: FiCloud,
    color: "text-sky-500",
...
export default function ProjectHeroVisualization() {
    ...
    <div className="relative w-full">
      {isMobile ? (
        <div className="relative w-full px-4 py-6 overflow-hidden">
          {/* Glow */}
          <div className="absolute w-[50vw] h-[50vh] top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gradient-to-r from-indigo-500/20 via-purple-500/20 to-sky-400/20 blur-3xl rounded-full" />
