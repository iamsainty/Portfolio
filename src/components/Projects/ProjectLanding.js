...
import priyanshucartoon from '../../media/priyanshu-cartoon-looking-up.webp';
                ...
                <div className="row align-items-center">
                    <div className="col-md-6 d-flex flex-column justify-content-center" style={{ paddingTop: '0vh' }} >
                        <div style={{ height: 'auto', color: props.mode === 'dark' ? 'white' : '#191919' }}>
                            ...
                            Dive into a captivating journey of innovation and creativity as you explore the array of projects meticulously crafted to inspire
                            </p>
                        </div>
