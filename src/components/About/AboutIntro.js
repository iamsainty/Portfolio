...
import priyanshucartoon from '../../media/priyanshu-about-avatar.webp';
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center" style={{ paddingTop: '0vh' }} >
                        <div style={{ height: 'auto', color: props.mode === 'dark' ? 'white' : '#191919' }}>
                            ...
                            <p style={{ fontSize: '2.25vh', paddingTop: '5vh' }}>
                                I am Priyanshu, a passionate creator weaving tales through design and code, sculpting digital experiences that resonate and inspire. Welcome to my creative journey.
                            </p>
                        </div>
